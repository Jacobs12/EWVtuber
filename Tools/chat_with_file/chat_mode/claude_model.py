...
from Tools.chat_with_file.chat_mode.chat_model import Chat_model

from Tools.gpt_model.gpt import GPT_MODEL
...
class Claude_mode(Chat_model):
    ...
    def load_zip_as_db(self, zip_file_path,
                       ...
                       chunk_size=300,
                       chunk_overlap=20):
        from Tools.chat_with_file.vector_store.faiss import create_faiss_index_from_zip
